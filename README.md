...
[![Version](https://img.shields.io/badge/version-5.1.19-blue.svg)](https://github.com/Dicklesworthstone/ultimate_bug_scanner)
...
|----------|---------|------------------|
| **JavaScript/TypeScript** | `promise.then()` without `.catch()`, `forEach(async ...)`, async array predicates, `Promise.all(map(...))` without callback return | Dangling promises, missing `await`, unawaitable async loops, unhandled rejections |
