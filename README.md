...
[![Version](https://img.shields.io/badge/version-5.1.17-blue.svg)](https://github.com/Dicklesworthstone/ultimate_bug_scanner)
...
|----------|---------|------------------|
| **JavaScript/TypeScript** | `promise.then()` without `.catch()`, `forEach(async ...)` | Dangling promises, missing `await`, unawaitable async loops, unhandled rejections |
