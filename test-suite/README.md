...
- The tracked golden coverage matrix in `test-suite/goldens/rule_coverage.json` still matches the manifest's paired security fixtures, runtime scopes, robustness scopes, metamorphic transform matrix, and default clean-fuzz budget.
