...
AST_GREP_SARIF_CHECKS = (
    ...
    },
    {
        ...
        "expected_rule_ids": (
            ...
            "java.executors-cached",
            "java.hardcoded-secrets",
            "java.inputstreamreader-no-charset",
            ...
            "java.notify",
            "java.optional-get",
            "java.optional-isPresent-then-get",
            "java.optional-isempty-negation",
            "java.optional-orElse-null",
            "java.parallel-foreach-side-effects",
            "java.paths-get-plus",
            "java.plain-http",
            ...
            "java.string-bytes-no-charset",
            "java.string-eq-operator",
            "java.synchronized-this",
            "java.system-println",
            "java.thread-sleep-in-synchronized",
            "java.thread-start",
